...
const Messagepage = () => {
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
      <div className="p-6 flex-1 overflow-y-auto">
        {/* Improved Messages Header */}
        <div className="text-center mb-12 space-y-3">
          <div className="flex items-center justify-center gap-4 mb-2">
            <div className="h-1 w-16 bg-gradient-to-r from-transparent to-indigo-500 rounded-full"></div>
            <FiMail className="text-indigo-600 text-4xl animate-pulse" />
          ...
          <p className="text-gray-600 text-lg font-medium">
            View and manage community messages
          </p>
